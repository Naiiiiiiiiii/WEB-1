...
(function() {
	...
	function createProductCard(product) {
		...
		const priceHtml = product.oldPrice && product.isOnSale()
	...
	function filterProducts() {
		...
		return products.filter(product => {
			...
			const priceMatch = (minPrice === null || productPrice >= minPrice) &&
	...
	function attachProductEventListeners() {
		...
		elements.searchResults.removeEventListener('click', searchResultsClickHandler); // Remove để tránh trùng lặp
