...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (!productGrid) {
    console.error('LỖI: .product-grid element not found in DOM. Cannot render.');
    return;
  }
  ...
  function renderList() {
    ...
    console.log(`LOG 3: Rendering ${slice.length} products (page ${currentPage}).`);
  ...
  function openQuickView(productId) {
    ...
    if (modalOptionsContainer) {
      ...
      const sizeOptions = [39, 40, 41, 42, 43].map(size => 
